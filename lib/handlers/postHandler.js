...
PostHandler.prototype.getRoot = function(req, res) {
  res.render('index.jade', {
    ...
    posts: Post.find({})
  }, responder(res, 'Error while rendering home page'));
};
...
PostHandler.prototype.getPost = function(req, res) {
  ...
  }, responder(res, 'Error while rendering post page'))
};

PostHandler.prototype.getWrite = function(req, res) {
  res.render('write.jade', {
    config: Config.findOne({})
  }, responder(res, 'Error while rendering write page'));
};
...
function responder(res, errorMessage) {

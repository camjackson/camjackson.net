...
function WriteItDown(handlers) {
  ...
  //For letsencrypt:
  this.app.get('/.well-known/acme-challenge/uRhd7V2-eAK-_CiqQ27SnhhXJ_9fczjc-3fq2Vn5PhA', (req, res) => {
    res.type('text/plain');
    res.send('uRhd7V2-eAK-_CiqQ27SnhhXJ_9fczjc-3fq2Vn5PhA.8RYOGbfpg_HSBz35otVictQhkbvFgKlGr7OIBKFFAdI');
  })
}

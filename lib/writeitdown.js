...
function WriteItDown(handlers) {
  ...
  //For letsencrypt:
  this.app.get('/.well-known/acme-challenge/g9Ug8szGd-oXoAzjNOvqnPm4NK_ooQvgIYuskFy9jnY', (req, res) => {
    res.type('text/plain');
    res.send('g9Ug8szGd-oXoAzjNOvqnPm4NK_ooQvgIYuskFy9jnY.8RYOGbfpg_HSBz35otVictQhkbvFgKlGr7OIBKFFAdI');
  })
}

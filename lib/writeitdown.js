...
function WriteItDown(handlers) {
  ...
  //For letsencrypt:
  this.app.get('/.well-known/acme-challenge/0zQJUC44nQuDtlcqTwU3iQBOZbjnLrNGTKimMQfTVhU', (req, res) => {
    res.type('text/plain');
    res.send('0zQJUC44nQuDtlcqTwU3iQBOZbjnLrNGTKimMQfTVhU.8RYOGbfpg_HSBz35otVictQhkbvFgKlGr7OIBKFFAdI');
  })
}

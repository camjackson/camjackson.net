...
function WriteItDown(handlers) {
  ...
  //For letsencrypt:
  this.app.get('/.well-known/acme-challenge/1pp22e7iLv3HciVjThX-efX5rSynd1DSaD2Mfo4FW8g', (req, res) => {
    res.type('text/plain');
    res.send('1pp22e7iLv3HciVjThX-efX5rSynd1DSaD2Mfo4FW8g.8RYOGbfpg_HSBz35otVictQhkbvFgKlGr7OIBKFFAdI');
  })
}

...
function WriteItDown(handlers) {
  ...
  //For letsencrypt:
  this.app.get('/.well-known/acme-challenge/JUZ-Uj1cpxf-V7NiF2AeWlq7cUVxMt6Tv8DZbt1FBZM', (req, res) => {
    res.type('text/plain');
    res.send('JUZ-Uj1cpxf-V7NiF2AeWlq7cUVxMt6Tv8DZbt1FBZM.8RYOGbfpg_HSBz35otVictQhkbvFgKlGr7OIBKFFAdI');
  })
}

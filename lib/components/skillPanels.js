...
let SkillPanel = require('./skillPanel');

class SkillPanels extends React.Component {
  constructor() {
    super();
    this.state = {
      skills: [
        ...
        },
        {
          ...
          tools: '1stConf 2015, DevOps Melbourne, Melbourne Functional Users Group, Melbourne & Monash Universities'
        }
      ]
    };
  }
  ...
  skillPanels() {
    return this.state.skills.map((skill) => {
      return <SkillPanel key={skill.title} skill={skill}/>
    });
  }
  ...
  render() {
    return (
      <div className="container">
        ...
        <div id="skill-panels" className="row">
          {this.skillPanels()}
        </div>
      </div>
    );

...
const skills = [
  {
    ...
    tools: 'HTML5, ES6, SASS, React, Flux/Redux, Bootstrap'
  },
  {
    title: 'Backend',
    body: 'I build APIs and command-line tools that are simple, secure, and scalable. Skills include:',
    tools: 'Ruby, Node.js, Python, Java, Rust, Go, SQL, MongoDB'
  },
  {
    title: 'Ops',
    ...
    tools: 'Linux, AWS, Docker, Puppet, Chef, Logstash'
  },
  {
    title: 'Methodologies',
    body: 'I love working with teams that are constantly striving to improve, using practices like:',
    tools: 'Agile, Lean, DevOps, Continuous Delivery, Test-Driven Development'
  },
  {
    title: 'Consulting',
